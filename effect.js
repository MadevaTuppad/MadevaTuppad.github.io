...
$('document').ready(function(){
	...
	$('#balloons_flying').click(function(){
		...
		$('#b1,#b4,#b5,#b8,#b9').addClass('balloons-rotate-behaviour-one');
	...
	$('#wish_message').click(function(){
		...
		$('#b22').animate({top:240, left: vw-0},500);
		$('#b33').animate({top:240, left: vw+100},500);
		$('#b44').animate({top:350, left: vw-250},500);
		$('#b55').animate({top:350, left: vw-150},500);
		$('#b66').animate({top:350, left: vw-50},500);
		$('#b77').animate({top:350, left: vw+50},500);
		$('#b88').animate({top:350, left: vw+150},500);
		$('#b99').animate({top:350, left: vw+250},500);
